...
function ImagePreview({id,path,version}:{id:string;path:string;version:string}){
  const [status,setStatus]=useState<'loading'|'ready'|'error'>('loading');
  const src='/api/sessions/'+encodeURIComponent(id)+'/files/image?path='+encodeURIComponent(path)+'&v='+encodeURIComponent(version);
