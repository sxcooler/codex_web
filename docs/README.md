...
- [无响应诊断](design/runtime-diagnostics.md)：有界日志、进程负载、HTTP/RPC 等待及隐私边界；新增诊断需重启服务后生效。
...
- [2026-09-23 0.1.5 发布验证](verification/2026-09-23-release-015.md)：当前功能基线、双平台测试、首页选项回归及产物发布门槛。
